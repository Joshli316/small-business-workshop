(function () {
  ...
  function toggleLang() {
    ...
    localStorage.setItem('sb_lang', isZh ? 'zh' : 'en');
  ...
  function revealActivity() {
    ...
    document.getElementById('struct-dba').classList.add('winner');
  ...
  try {
    new QRCode(document.getElementById('qr-container'), {
      text: 'https://small-business-workshop.pages.dev/resources',
      width: 148,
      height: 148,
      colorDark: '#9a3412',
      colorLight: '#fef7f0'
    ...
    if (el) el.textContent = 'small-business-workshop.pages.dev/resources';
  }
