...
test('resources page loads with checklist tables', async ({ page }) => {
  await page.goto('/resources.html');
  await expect(page.locator('h1, .resources-title-zh').first()).toBeVisible();
  // 7 sections in resources.html
  await expect(page.locator('.resource-section')).toHaveCount(7);
});
